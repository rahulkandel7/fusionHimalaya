...
@section('content')
    <div class="py-10 px-8 w-full">
        <div class="flex justify-between py-2">
          ...
          <form action="{{route('admin.galleries.store')}}" method="post" enctype="multipart/form-data" class="py-5 dark:text-gray-700">
            @csrf
            ...
            <div class="flex my-6">
                <a href="{{route('admin.galleries.index')}}" class="bg-red-400  px-8 py-1 rounded-md shadow-md hover:shadow-lg hover:bg-red-500 text-white">
                    Cancel
                </a>
