        ...
        <div class="flex justify-between py-2">
          ...
          <form action="{{route('admin.lunches.update',$lunch->id)}}" method="post" enctype="multipart/form-data" class="py-5 dark:text-gray-700">
            ...
            <div class="my-2">
                ...
                <img src="{{asset('public/'.$lunch->photopath)}}" alt="" class="w-32 h-32 rounded-md shadow-md">
            </div>
            ...
            <div class="my-2">
                ...
                <input type="number" name="priority" id="" class="w-full border-none shadow-lg rounded-md placeholder:text-gray-700 focus:ring-indigo-700" placeholder="Enter priority" value="{{$lunch->priority}}">
                @error('priority')
                    <p class="text-red-500 p-2">
                        {{$message}}
                    </p>
