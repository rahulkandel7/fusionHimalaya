            ...
            <table id="index" class="display dark:text-slate-300 w-full">
                <thead >
                    <tr class="text-left border border-gray-200">
                        ...
                        <th class="p-2">Is Lactose Free</th>
                        <th class="p-2">Is Gluten Free</th>
                        <th class="p-2">Is Vegan</th>
                ...
                <tbody class="text-gray-900 dark:text-slate-300">
                    ...
                    <tr class=" border-gray-200 border dark:border-gray-600 dark:bg-gray-500">
                        ...
                        <td class="p-2">{{$lunch->isLactoseFree == 1 ? 'Yes' : 'No'}}</td>
                        <td class="p-2">{{$lunch->isGlutenFree == 1 ? 'Yes' : 'No'}}</td>
                        <td class="p-2">{{$lunch->isVegan == 1 ? 'Yes' : 'No'}}</td>
