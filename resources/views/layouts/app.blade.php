        ...
        <div class="min-h-screen bg-gray-50">
            ...
            <div class="hidden md:block w-full sticky top-0 bg-gray-50 shadow-sm z-10">
                <div class="flex w-11/12 mx-auto justify-between items-center py-2">
                    ...
                    <div>
                        <ul class="flex">
                            <a href="{{route('home')}}" class="hover:text-red-500 mx-5 @if (Route::currentRouteName() == 'home') text-red-500 @endif" >
                                <li>
                                    Home
                                </li>
                            </a>
                            ...
                            <a href="{{route('gallery')}}" class="hover:text-red-500 mx-5 @if (Route::currentRouteName() == 'gallery') text-red-500 @endif">
                                <li>
                                    Gallery
                                </li>
                            </a>
                            ...
                            <a href="{{route('contact')}}" class="hover:text-red-500 mx-5 @if (Route::currentRouteName() == 'contact') text-red-500 @endif" >
                                <li>
                                    Contact Us
                                </li>
                            </a>
            ...
            <div class="w-full bg-gray-600 ">
                <div class="w-11/12 mx-auto py-10 grid md:grid-cols-3">
                    <div>
                        <img src="{{asset('images/logo.png')}}" alt="Logo" class="w-40 bg-white rounded-full object-contain">
